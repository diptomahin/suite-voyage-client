        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
          <form onSubmit={handleRegister} className="card-body">
            ...
            <div className="form-control mt-6">
              <button className="btn" style={{ backgroundColor: "#D49B35", color: "white" }}>Register</button>
              {
                errorMessage ?
                  <div className="my-3 ">
              ...
              <p className="mt-5 text-xs">Already have an account???<span className="text-[#D49B35]"><Link to='/login'>Login Now!</Link></span></p>
            </div>
          </form>
        </div>
      </div>
